    ...
    <div class="container">
        ...
        <div class="mainpage">
            <div class="about">
                ...
                <p>Welcome to MediCorner, your comprehensive healthcare partner dedicated to providing reliable medical information, telemedicine services, and community support. Our mission is to bridge the gap between patients and healthcare providers, ensuring seamless access to essential medical resources and support. At MediCorner, we believe in empowering individuals with the knowledge and tools they need to take charge of their health.</p>
            </div>
            <div class="image">
                <img src="https://i.ibb.co/7zT1Hpb/medical.jpg" alt="Medical Image">
            </div>
        </div>
    </div>
</body>
